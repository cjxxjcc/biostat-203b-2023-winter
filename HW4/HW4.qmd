...
final_fit %>% 
  collect_metrics()
```
**Solution**: Support Vector Machines accuracy is 0.9218778
...
**Solution**: We could conclude that the boosting analytic approach have the highest accuracy, and Support Vector Machines approach have the lowest accuracy.