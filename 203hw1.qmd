...
**URL**:https://www.citiprogram.org/verify/?kcef6cd6e-fa3b-4ec7-afe9-9c9bf93e01c3-53879823
...
**Solution** : lrwxr-xr-x  1 chengjiaxin  staff  51 Jan 24 14:24 /Users/chengjiaxin/mimic -> /Users/chengjiaxin/Desktop/Biostat203b/mimic-iv-1.0
...
**core**: admissions.csv.gz	 patients.csv.gz  index.html  transfers.csv.gz

**hosp**: d_hcpcs.csv.gz				      labevents.csv.gz
          d_icd_diagnoses.csv.gz			labevents_filtered_itemid.csv.gz
          d_icd_procedures.csv.gz			microbiologyevents.csv.gz
          d_labitems.csv.gz			      pharmacy.csv.gz
          diagnoses_icd.csv.gz		    poe.csv.gz
          drgcodes.csv.gz				      poe_detail.csv.gz
          emar.csv.gz				          prescriptions.csv.gz
          emar_detail.csv.gz		    	procedures_icd.csv.gz
          hcpcsevents.csv.gz			    services.csv.gz
          index.html

**icu**: chartevents.csv.gz			            index.html
         chartevents_filtered_itemid.csv.gz	inputevents.csv.gz
         d_items.csv.gz			               	outputevents.csv.gz
         datetimeevents.csv.gz			        procedureevents.csv.gz
         icustays.csv.gz
